...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
      TAB,GUIQ,GUIW,    ,PGUP,GUIT,                   ,HOME, UP, END, PSCR,PAUS,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     GITB,GUIA,GUIS,    ,PGDN,    ,                   ,LEFT,DOWN,RGHT,    ,    ,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
     LSFT,GUIZ,GUIX,GUIC,GUIV,    ,LGUI,     RGUI,    ,    ,LBRC,RBRC,    ,RSFT,
  //`----+----+----+----+----+----+----/    \----+----+----+----+----+----+----'
                       LCTL,LALT,GISP,         ENT,     ,
  //                  `----+----+----'        `----+----+----'
  ),
